...
let rerenderEntreTree = (state: stateType) => {
...
// }
// export const changeNewPostText = (newTextPost: string) => {
//     state.profilePage.newPosts = newTextPost
//     rerenderEntreTree(state)
// }
//
